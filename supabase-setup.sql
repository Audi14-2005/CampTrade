-- Supabase setup script for CampTrade
...
-- Sample data insertion removed to avoid foreign key constraint errors
-- Users will be created automatically when they sign up through the authentication system
